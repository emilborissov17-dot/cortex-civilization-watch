...
## Problem
Extreme drought currently affecting 44% of Puerto Rico, threatening water availability and food production

## Root Cause
Climate change–driven shift in precipitation patterns combined with insufficient regional water management infrastructure

## Proposed Actions
- **Deploy large‑scale rainwater harvesting and underground storage systems in drought‑prone municipalities, paired with the introduction of drought‑resistant crop varieties** — Increase stored water capacity by 30% and reduce the proportion of land classified as extreme drought from 44% to under 20% within three years
