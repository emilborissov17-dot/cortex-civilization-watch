...
## Root Cause
Conflict, climate change, and unsustainable farming practices

## Proposed Actions
- **Implement and support community farm programs to increase local food production** — Reduce the number of people facing acute hunger by 10% within the next 2 years
